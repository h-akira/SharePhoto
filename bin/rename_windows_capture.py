...
""", formatter_class = argparse.ArgumentDefaultsHelpFormatter)
  ...
  parser.add_argument("--formats", metavar="format", default=[
    "[0-9]+_[0-9]+_[0-9]+\ [0-9]+_[0-9]+_[0-9]",
    "[0-9]+-[0-9]+-[0-9]+\ [0-9]+-[0-9]+-[0-9]"
  ], help="format of input-file without first halg and extension")
